...
def home():
    ...
    if request.method == "POST":
        ...
        wb.save(filename)
        return render_template("home.html", choose_file=False, Names=Names, IA_1s=IA_1s, IA_one=IA_one, A1=A1,
                               IA_2s=IA_2s, IA_two=IA_two, A2=A2, IA_3s=IA_3s, IA_three=IA_three)
